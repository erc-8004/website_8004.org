      ...
      <section className="relative py-20 bg-white overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-8 text-[#7c3aed]">Learn about 8004 & x402</h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              {[
                ...
                <div key={index} className="bg-white p-6 rounded-2xl border border-[#e4e4e7] card-shadow hover:border-[#7c3aed] transition-colors duration-200 text-center">
                  <h4 className="font-display font-bold text-lg text-[#7c3aed] mb-3">{item.title}</h4>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 relative" style={{ zIndex: 1 }}>
                {[
                  ...
                  <div key={item.num} className="bg-white p-6 rounded-2xl border border-[#e4e4e7] card-shadow relative">
                    <div className="absolute top-4 left-4 w-8 h-8 bg-[#7c3aed] text-white rounded-full flex items-center justify-center font-bold text-sm">
                      {item.num}
                    </div>
              ...
              <div className="relative pt-8 pb-8">
                <div className="flex justify-center relative z-10">
                  <div className="bg-[#f3f0ff] px-6 py-3 rounded-xl inline-block">
                    <p className="text-sm font-semibold text-[#7c3aed]">Feedback loop</p>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <ul className="space-y-3 text-[#3f3f46]">
                      {[
                        ...
                        <li key={index} className="flex items-start">
                          <span className="mr-3 mt-2 w-1.5 h-1.5 bg-[#7c3aed] rounded-full flex-shrink-0"></span>
                          <span>{item}</span>
                        </li>
                      ))}
                    </ul>
              ...
              <div className="space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={index} className="bg-white border border-[#e4e4e7] rounded-2xl p-6 card-shadow hover:border-[#7c3aed] transition-colors duration-200">
