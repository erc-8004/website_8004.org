              ...
              <div className="max-w-full text-center">
                ...
                <div className="flex flex-wrap justify-center gap-12 mb-8 max-w-5xl mx-auto">
                  {[
                    ...
                    { name: 'Abstract', logo: '/logos/chainLogos/abstract.jpg', comingSoon: false },
                    { name: 'Arbitrum', logo: '/logos/chainLogos/arb-mainnet.svg', comingSoon: false },
                    { name: 'Avalanche', logo: '/logos/chainLogos/avalanche.png', comingSoon: false },
                    { name: 'Celo', logo: '/logos/chainLogos/celo.jpg', comingSoon: false },
                    { name: 'Gnosis', logo: '/logos/chainLogos/gnosis.jpg', comingSoon: false },
                    { name: 'Goat Network', logo: '/logos/chainLogos/goat.png', comingSoon: false },
                    { name: 'Linea', logo: '/logos/chainLogos/linea-mainnet.svg', comingSoon: false },
                    { name: 'Mantle', logo: '/logos/chainLogos/mantle.png', comingSoon: false },
                    { name: 'MegaETH', logo: '/logos/chainLogos/megaeth.jpeg', comingSoon: false },
                    ...
                    { name: 'XLayer', logo: '/logos/chainLogos/xlayer.jpeg', comingSoon: false },
