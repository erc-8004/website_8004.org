...
const authors: TeamMember[] = [
  ...
  },
  {
    ...
    company: 'Coinbase',
    image: '/team/erik-reppel.jpeg',
    linkedin: 'https://www.linkedin.com/in/erikreppel/',
    twitter: 'https://x.com/programmer',
  },
  {
    name: 'Jordan Ellis',
    role: 'Software Engineer',
    company: 'Google',
    image: '/team/jordan-ellis.png',
    linkedin: 'https://www.linkedin.com/in/jordan-ellis-34211966/',
  },
];
...
const teamMembers: TeamMember[] = [
  {
    ...
    twitter: 'https://x.com/isha_sangani',
  },
  {
    name: 'Leonard Tan',
...
function PersonCard({ person }: { person: TeamMember }) {
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <h3 className="font-display text-lg font-semibold text-[#18181b] mb-1">
        {person.name}
      </h3>
      ...
      {!person.role && !person.company && <div className="mb-3" />}
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative pt-40 pb-28 bg-white overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl text-[#71717a] max-w-3xl mx-auto leading-relaxed">
            The authors and team behind the ERC-8004 standard
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#fafafa]">
        <div className="container mx-auto px-6">
          <h2 className="font-display text-3xl md:text-4xl font-bold text-center mb-16 text-[#18181b]">
            Authors
          </h2>
